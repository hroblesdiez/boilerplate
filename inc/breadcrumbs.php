 ...
 */
//add_action( 'generate_before_content', 'hrd_add_breadcrumb' );
function hrd_add_breadcrumb() {
    hrd_breadcrumbs();
}
 ...
 */
 function hrd_breadcrumbs() {
    ...
    if ( is_home() ) {
        $showOnHome = 1;
        if ( $showOnHome == 1 ) echo '<div id="crumbs" class="breadcrumbs"><a href="' . $homeLink . '">' . $home . '</a>' . $delimiter . ' ' .$before .' Blog ' . $after . ' </div>';
        ...
        if ( is_category() ) {
            ...
            echo $before . ' <a href="' . site_url('blog') . '"> Blog</a> '. $delimiter .' ' . single_cat_title('', false) . ' ' . $after;
